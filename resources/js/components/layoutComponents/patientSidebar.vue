    ...
    <div class="container">
      ...
      <div class="menu" :class="{ 'menu-closed': !isSidebarOpen }">
        <table class="menu-container" border="0">
              ...
              <table border="0" class="profile-container">
                <tr>
                  ...
                  <td style="padding:0px;margin:0px;">
                    <p class="profile-title">{{ capitalizedUserName }}</p>
          ...
          <!-- Sidebar Links -->
          <tr class="menu-row">
            <td class="menu-btn menu-icon-dashbord" :class="{ 'menu-active': isActive('/patient-dash') }">
              <router-link to="/patient-dash" class="non-style-link-menu" active-class="non-style-link-menu-active">
                <div class="menu-item">
          ...
          <tr class="menu-row">
            <td class="menu-btn menu-icon-doctor" :class="{ 'menu-active': isActive('/doctor-view') }">
              <router-link to="/doc-list" class="non-style-link-menu" active-class="non-style-link-menu-active">
                <div class="menu-item">
